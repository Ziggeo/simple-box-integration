...
class BoxRequest
{
     ...
     * @return BoxRequest
     */
    public function setFile(BoxFile $file)
    {
        $this->file = $file;
     ...
     *
     * @return Http\RequestBodyJsonEncoded
     */
